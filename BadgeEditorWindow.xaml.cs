...
public partial class BadgeEditorWindow : Window
{
    ...
    {
        InitializeComponent();
        Result = source is null ? new BadgeRecord() : new BadgeRecord { Id=source.Id, Number=source.Number, Hex=source.Hex, Decimal=source.Decimal, Technology=source.Technology, Starprox=source.Starprox, Notes=source.Notes, ScannedAt=source.ScannedAt };
        NumberBox.Text = Result.Number; NotesBox.Text = Result.Notes; StarproxBox.IsChecked = Result.Starprox;
    ...
    private void Save_Click(object sender, RoutedEventArgs e)
    {
        ...
        Result.Number = number; Result.Technology = tech; Result.Starprox = StarproxBox.IsChecked == true; Result.Notes = NotesBox.Text.Trim();
